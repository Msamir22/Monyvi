...
| Provider logos                                                         | `egyptian-institution-assets.test.ts`, `account-institution-read-model-service.test.ts`, `AccountCard.test.tsx`                                          | Provider-specific logo source review pending |
